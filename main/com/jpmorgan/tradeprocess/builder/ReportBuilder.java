package com.jpmorgan.tradeprocess.builder;

import static com.jpmorgan.tradeprocess.Constant.INSTRUCTION_TYPE_BUY;
import static com.jpmorgan.tradeprocess.Constant.INSTRUCTION_TYPE_SELL;
...
public class ReportBuilder {
	...
	private void populateReportAttributes(ReportData report,
		...
		double amount = ReporterUtil.getAmountInUSD(data.getSharePrice(), data.getUnits(), data.getFxRate());
